...
var _ProductsTable = __webpack_require__(59);

var _ProductsTable2 = _interopRequireDefault(_ProductsTable);

var _api_calls = __webpack_require__(63);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function fetchProducts() {
      ...
      (0, _api_calls.getProducts)().then(function (res) {
        _this2.setState({ products: res.data, loading: false, filteredProducts: res.data });
      });
    }
    ...
    key: 'filterProducts',
    value: function filterProducts(input) {
    ...
    value: function handleSearchInput(event) {
      event.preventDefault();
      var searchedProducts = this.filterProducts(event.target.value);
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_Navbar2.default // the function to handle changes in the input of the search bar is passed as props to the Navbar component
        , { handleSearchInput: this.handleSearchInput
        }),
        _react2.default.createElement(_ProductsTable2.default // all products (at first) and the filtered products are passed as props to the ProductsTable component to display them along with the value of loading.
...
var _logoGarbarino = __webpack_require__(58);

var _logoGarbarino2 = _interopRequireDefault(_logoGarbarino);
...
exports.default = function (_ref) {
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement('img', { src: _logoGarbarino2.default, alt: 'Garbarino logo' }),
			_react2.default.createElement(
				'div',
				{ className: 'form-inline' },
				_react2.default.createElement('input', { onChange: function onChange(event) {
						return handleSearchInput(event);
					}, className: 'form-control mr-sm-2', type: 'search', placeholder: 'Nombre del Producto', 'aria-label': 'Search' })
			)
		)
	);
};
...
module.exports = __webpack_require__.p + "./assets/logo-garbarino.png";
...
var _loadingSpinner = __webpack_require__(62);
...
exports.default = function (_ref) {
  ...
  return _react2.default.createElement(
    'div',
    null,
    loading ? _react2.default.createElement('img', { className: 'loading-spinner', src: _loadingSpinner2.default, alt: 'Loading Spinner' }) : // if loading is true then show the loading gif, if loading is false display the products table
    _react2.default.createElement(
      'div',
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          products.map(function (product) {
            return (// map all products in the products array to display the information from each of them
              _react2.default.createElement(
                'tr',
                { key: product.name },
                _react2.default.createElement(
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./ProductsTable.scss", function() {
		var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./ProductsTable.scss");
...
module.exports = __webpack_require__.p + "./assets/loading-spinner.gif";
